...
## Deployment Details
```{r}
dd <- read.csv(here::here("R/Test Spreadsheets/Deployment Details - NEW DEPLOYMENT TO SAVE.csv"))
```

## PACE Templates
```{r}
MobileMarineTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Mobile-Marine-NCEI-PACE-Template.xlsx"))
```
...
MobileMarineData <- data.frame(
  ...
  # File Paths Tab
    ...
    "Other Path" = '', #include acceleration and ...
  ...
  # Contacts Tab
    ...
    "Sources" = 'NOAA SWFSC', # Sponsers, swfsc
  ...
  # Location Tab
    ...
    "File(s)" = paste0('Z:/METADATA/CalCurCEAS_2024/', dd$Drift., '/', dd$Drift., '_GPS'), # Path to GPS data
...
write_xlsx(MobileMarineData, here::here("R/Test Spreadsheets/ExportedMobileMarineData.xlsx"))
```
