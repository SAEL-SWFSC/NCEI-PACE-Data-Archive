...
## PACE NCEI-Templates
```{r}
MobileMarineTemplate <- read_xlsx(here::here("R/Spreadsheets & Templates/NCEI-Templates/Mobile-Marine-NCEI-PACE-Template.xlsx"))
```
...
MobileMarineData <- data.frame(
  ...
  # File Paths Tab
    ...
    "Other Path" = paste0('C:/Users/kourtney.burger/Desktop/CalCurCEAS PACE/metadata/',
                                dd$Data_ID[i]), #include acceleration, logs, and depth data
  ...
  # Calibration Tab
    "Calibration Documents Path" = '', # link to calibration file, make one for project if necessary
  ...
  # Location Tab
    ...
    "File(s)" = paste0('C:/Users/kourtney.burger/Desktop/CalCurCEAS PACE/metadata/gps/', dd$Data_ID[i]), # Path to GPS data
  
  # Quality Tab
    "Quality Analyst" = dd$Quality_Analyst,                          
    # "Quality Analysis Objectives" = '', # Type out objectives
    # "Quality Analysis Method" = '', # Type out method, i.e. scanned ltsa ...
