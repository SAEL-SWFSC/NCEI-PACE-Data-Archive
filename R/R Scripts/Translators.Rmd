...
dd <- read.csv(here::here("R/Test Spreadsheets/Deployment Details - NEW DEPLOYMENT TO SAVE- TEMPLATE TEST.csv"))
```
...
ProjTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Project-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(Projects, here::here("R/Test Spreadsheets/Projects.xlsx"))
```

# Person
```{r}
# Read in template spreadsheet and set up dataframe
PersonTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Person-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(Person, here::here("R/Test Spreadsheets/Person.xlsx"))
```

# Organizations
```{r}
# Read in template spreadsheet and set up dataframe
OrgTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Organization-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(Organization, here::here("R/Test Spreadsheets/Organization.xlsx"))
```

# Instruments
```{r}
# Read in template spreadsheet and set up dataframe
InstrumentTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Instrument-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(Instruments, here::here("R/Test Spreadsheets/Instruments.xlsx"))
```
...
```{r}
# Read in template spreadsheet and set up dataframe
HydrophoneTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Hydrophone-Sensor-KB-Template.xlsx"))

# Read in hydrophone inventory for more metadata
HPInventory <- read.csv(here::here("R/Test Spreadsheets/Inventory - Hydrophones.csv"))
...
# Export dataframe
write_xlsx(Hydrophones, here::here("R/Test Spreadsheets/Hydrophones.xlsx"))
```

## Depth Sensors
```{r}
# Read in template spreadsheet and set up dataframe
DepthTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Depth-Sensor-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(Depth, here::here("R/Test Spreadsheets/DepthSensors.xlsx"))
```

## GPS and others
```{r}
# Read in template spreadsheet and set up dataframe
GPSTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/GPS-other-Sensor-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(GPS, here::here("R/Test Spreadsheets/GPS&OtherSensors.xlsx"))
```
...
```{r}
# Read in template spreadsheet and set up dataframe
ShipTemplate <- read_xlsx(here::here("R/Test Spreadsheets/Templates/Ship-KB-Template.xlsx"))
...
# Export dataframe
write_xlsx(Ship, here::here("R/Test Spreadsheets/Ships.xlsx"))
```
