...
#Need to fill in organization specific information manually before translating this metadata to PACE
...
# Add instrument list from deployment details to list
...
# Add hydrophones from inventory to list
...
# Add depth sensors from deployment details to list
Depth <- data.frame(
...
# Add GPS devices from deployment details to list
GPS <- data.frame(
